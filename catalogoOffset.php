			  ...
			  <div id="categorias">
			  	...
			  	<div id="categoria1" class="productos">
				  	<div  id="activado" class="producto">
				  		<img onclick="javascript:mostrar_ventana('159854','botones1','$8','img/botones/pines1.jpg');" width="350px" height="150px" src="img/offset/offset1.jpg">

				  	</div>
                                           <?php
                    
                                                $informacionProducto = new gestor_de_catalogo();
                                                echo  $informacionProducto->generar_infoOffset();

                    
                                           ?>
                                    
				  	<div class="producto">
				  		<img onclick="javascript:mostrar_ventana('1243','Cacharel','$600','img/botones/pines1.jpg');" width="350px" height="150px" src="img/offset/offset2.jpg">
				  	</div>
                                           ...
                                           ?>
				  	<div class="producto">
				  		<img onclick="javascript:mostrar_ventana('134536','Cacharel','$700','img/Damas/3.png');" width="350px" height="150px" src="img/offset/offset3.jpg">
				  	</div>
				  	...
				  	<div class="producto">
				  		<img onclick="javascript:mostrar_ventana('234421','Cacharel','$800','img/Damas/4.png');" width="350px" height="150px" src="img/offset/offset4.jpg">
