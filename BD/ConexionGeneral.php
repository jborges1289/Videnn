...
class ConexionGeneral {
    ...
    private function selecionarBD($conexion) {
        return mysql_select_db($GLOBALS["base_datos"], $conexion) or die ('<div class="error" style="font-family:Arial, Helvetica, sans-serif;font-size:20px;">Intente acceder en otro momento ERROR: " ' . mysql_error());
    } 
